import pygame
import os
from ambatuking import ambatuking
from archertower import ArcherTowerLong, ArcherTowerShort
from supporTower import DamageTower, RangeTower
...
path =[(8,194), (100, 198), (100, 450), (400, 450), (400, 75),(700,73),(700,600),(975,600),(975,375),(1300,370)]

lives_img = pygame.image.load(os.path.join("asset","heart.png")).convert_alpha()
star_img = pygame.image.load(os.path.join("asset","star.png")).convert_alpha()
side_img = pygame.transform.scale(pygame.image.load(os.path.join("asset","side.png")).convert_alpha(), (120, 500))

buy_archer = pygame.transform.scale(pygame.image.load(os.path.join("asset","buy.png")).convert_alpha(), (75, 75))
buy_archer_2 = pygame.transform.scale(pygame.image.load(os.path.join("asset","buy.png")).convert_alpha(), (75, 75))
buy_damage = pygame.transform.scale(pygame.image.load(os.path.join("asset","damage.png")).convert_alpha(), (75, 75))
buy_range = pygame.transform.scale(pygame.image.load(os.path.join("asset","range.png")).convert_alpha(), (75, 75))

play_btn = pygame.transform.scale(pygame.image.load(os.path.join("asset","button_start.png")).convert_alpha(), (75, 75))
pause_btn = pygame.transform.scale(pygame.image.load(os.path.join("asset","button_pause.png")).convert_alpha(), (75, 75))

sound_btn = pygame.transform.scale(pygame.image.load(os.path.join("asset","button_sound.png")).convert_alpha(), (75, 75))
sound_btn_off = pygame.transform.scale(pygame.image.load(os.path.join("asset","button_sound_off.png")).convert_alpha(), (75, 75))

wave_bg = pygame.transform.scale(pygame.image.load(os.path.join("asset","wave.png")).convert_alpha(), (225, 75))
...
class Game:
    def __init__(self, win):
        ...
        self.lives = 10
        self.money = 2000
        self.bg = pygame.image.load(os.path.join("asset", "map.png"))
