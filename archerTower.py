...
menu_bg = pygame.transform.scale(pygame.image.load(os.path.join("asset", "menu.png")).convert_alpha(), (120, 70))
upgrade_btn = pygame.transform.scale(pygame.image.load(os.path.join("asset", "upgrade.png")).convert_alpha(), (50, 50))
...
for x in range(1,3):
    tower_imgs1.append(pygame.transform.scale(
        pygame.image.load(os.path.join("asset/Turret1", str(x) + ".png")).convert_alpha(),
        (90, 90)))
...
for x in range(1,3):
    tower_imgs.append(pygame.transform.scale(
        pygame.image.load(os.path.join("asset/Turret1", str(x) + ".png")),
        (90, 90)))
