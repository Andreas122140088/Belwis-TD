...
class Turret(pg.sprite.Sprite):
  def __init__(self, sprite_sheets, tile_x, tile_y, shot_fx, cooldown, range):
    ...
    self.animation_list = self.load_images(self.sprite_sheets[0])
    self.frame_index = 0
  ...
  def upgrade(self, cooldown, range):
    self.cooldown = cooldown
    self.range = range
